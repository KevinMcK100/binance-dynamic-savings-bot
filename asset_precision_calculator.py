...
class AssetPrecisionCalculator:
    ...
    def get_asset_precision(self, asset: str):
        print(f"Getting presicion for asset: {asset}")
        precision = 2
        try:
            ...
            print(f"Error getting precision for asset {asset}. Defaulting to 2 DP. Error: {ex}")
            logging.exception(ex)
        print(f"Calculated precision at {precision} DP for asset {asset}")
        return precision
